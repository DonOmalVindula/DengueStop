...
class EventCard extends StatelessWidget {
  ...
  Color changeEventBoxColor(statusId) {
    switch(statusId) {
      case 2:
        return Colors.teal[900].withOpacity(
            0.5);
      case 3:
      ...
      case 4:
        return Colors.black.withOpacity(
            0.5);
      case 5:
        return Colors.red[900].withOpacity(
            0.5);
      default:
        return Colors.black;
    }
  ...
  @override
  Widget build(BuildContext context) {
    String formattedTimestamp = DateFormat('dd/MM/yyyy @ h:mm a').format(this.eventDate);
    // styles for event name label
    final TextStyle eventNameStyle = TextStyle(
        fontSize: 18.0, fontWeight: FontWeight.w700, color: changeEventTextColor(this.status));
    // styles for event details
    final TextStyle eventDetailsStyle = TextStyle(
        fontSize: 16.0, fontWeight: FontWeight.w500, color: changeEventTextColor(this.status));
    ...
    return Container(
      ...
      height: 120,
      decoration: BoxDecoration(
          color: changeEventBoxColor(this.status), //todo dynamically change opacity based on event status
